...
// Query per ottenere le sbobine in ritardo $num_sbobine_late
$sql5 = "SELECT COUNT(*) as num_sbobine_late 
         FROM sx_sbobine_calendarizzate 
         WHERE DATE_SUB(CURDATE(), INTERVAL 6 DAY) > data_lezione
         AND caricata = 0";
$stmt5 = $conn->prepare($sql5);
$stmt5->execute();
$stmt5->bind_result($num_sbobine_late);
$stmt5->fetch();
$stmt5->close();
